...
#define H8_3069F_SCI_SCR_CKE (1<<0)
#define H8_3069F_SCI_SCR_CK1 (1<<1)
#define H8_3069F_SCI_SCR_TEIT (1<<2)
...
{
	volatile struct h8_3069f_sci* sci = regs[index].sci;
	sci->scr |= H8_3069F_SCI_SCR_TIE;/*ビットを立てて有効化*/
}
...
void serial_intr_recv_disable(index)
{
	volatile struct h8_3069f_sci* sci = regs[index].sci;
	sci->scr &= ~H8_3069F_SCI_SCR_RIE;/*ビットを立てて有効化*/
}
